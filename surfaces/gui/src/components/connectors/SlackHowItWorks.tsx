...
// reads as a screenshot of Slack), QunWork on the right (app tokens). Tabs
...
const CAPTIONS = [
  "Mention @QunWork in any channel it's invited to — a session opens here, and the answer lands back in Slack as a thread.",
    ...
    <div className="mb-5" data-testid="slack-howitworks">
      <div className="flex items-baseline gap-2.5">
        <h3 className="text-[13.5px] font-semibold tracking-tight">
          Getting started with Slack &amp; QunWork
        </h3>
        <button
...
function SlackRail({ active }: { active: string }) {
  return (
    <div className="hiw-slrail">
      ...
      <div className="hiw-slnav"><span className="hiw-appav">QW</span>QunWork</div>
    </div>
  );
}
  ...
  return (
    <div className="hiw-win hiw-ow">
      <div className="hiw-owtop">
        <span className="hiw-dots"><i /><i /><i /></span> QunWork
      </div>
        ...
        <div className="hiw-slmain">
            ...
            <Msg
              ...
              extra={
                <span className="hiw-replybar hiw-k" style={d("4.6s")}>
                  <span className="hiw-sav2">QW</span> 1 reply
                  <span className="hiw-later">Today at 6:34 PM</span>
                </span>
              }
            >
              <span className="hiw-men">@QunWork</span> summarize this thread
            </Msg>
          </div>
          ...
          <div className="hiw-slthread hiw-k" style={d("5.1s")}>
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="QW" avBg="#4a154b" name="QunWork" app ts="6:34 PM">
      ...
      <OwWin>
        ...
        <div className="hiw-owmain">
          ...
          <div className="hiw-owchat">
            <div className="hiw-bub user hiw-k" style={d("2.8s")}>@QunWork summarize this thread</div>
          ...
          <div className="hiw-owcomposer">Message QunWork…</div>
        </div>
      </OwWin>
    </>
  );
            ...
            <Msg
              ...
              extra={
                <span className="hiw-replybar">
                  <span className="hiw-sav2">QW</span> 2 replies
          ...
          <div className="hiw-slthread">
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="P" avBg="#7c6cd0" name="Priya N" ts="6:36 PM" delay=".8s">
                <span className="hiw-men">@QunWork</span> break it down by country?
              </Msg>
              <Msg av="QW" avBg="#4a154b" name="QunWork" app ts="6:36 PM" delay="4.8s">
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@QunWork</span> pull the signup numbers?
            </Msg>
          </div>
          <SlackComposer placeholder="Message #launch-room" />
        </div>
